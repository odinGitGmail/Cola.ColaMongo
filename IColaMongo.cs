...
public interface IColaMongo
{
    ...
    UpdateResult UpdateOne<T>(UpdateDefinition<T> update, FilterDefinition<T> filter, string collName);
    ...
    /// <param name="filter">修改条件</param>
    /// <returns>UpdateResult</returns>
    Task<UpdateResult> UpdateOneAsync<T>(UpdateDefinition<T> update, FilterDefinition<T> filter,
        string collName);
    ...
    /// <param name="filter">修改条件</param>
    /// <returns>UpdateResult</returns>
    UpdateResult UpdateManay<T>(UpdateDefinition<T> update, FilterDefinition<T> filter, string collName);
    ...
    /// <param name="filter">修改条件</param>
    /// <returns>UpdateResult</returns>
    Task<UpdateResult> UpdateManayAsync<T>(UpdateDefinition<T> update, FilterDefinition<T> filter,
        string collName);
